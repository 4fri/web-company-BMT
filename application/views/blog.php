...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <div class="site-wrap">
                    ...
                    <div class="col-12 col-md-10 d-none d-xl-block">
                        <nav class="site-navigation position-relative text-right" role="navigation">
                            ...
                            <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                                ...
                                <li><a href="<?= base_url('home/blog') ?>" class="nav-link active">Blog</a></li>
        ...
        <div class="site-blocks-cover overlay" style="background-image: url(<?= base_url() ?>assets/images/hero_1.jpg);" data-aos="fade">
            <div class="container">
                <div class="row align-items-center justify-content-center">


                    <div class="col-md-9 mt-lg-5 text-center">
                        <h1>Repudiandae Quisquam Eaque Dolore</h1>
                        <p class="post-meta">September 20, 2019 &bull; Posted by <a href="#">Admin</a> in <a href="#">Events</a></p>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 blog-content">
                        <div class="row mb-5">
                            <div class="col-lg-6">
                                <figure><img src="<?= base_url() ?>assets/images/img_3.jpg" alt="Free Website Template by Free-Template.co" class="img-fluid">
                                    <figcaption>This is an image caption</figcaption>
                                </figure>
                            </div>
                            <div class="col-lg-6">
                                <figure><img src="<?= base_url() ?>assets/images/img_4.jpg" alt="Free Website Template by Free-Template.co" class="img-fluid">
                                    <figcaption>This is an image caption</figcaption>
                                </figure>
                            </div>
                        </div>
                        ...
                        <div class="pt-5">
                            ...
                            <ul class="comment-list">
                                <li class="comment">
                                    <div class="vcard bio">
                                        <img src="<?= base_url() ?>assets/images/person_1.jpg" alt="Free Website Template by Free-Template.co">
                                    </div>
                    ...
                    <div class="col-md-4 sidebar">
                        ...
                        <div class="sidebar-box">
                            <img src="<?= base_url() ?>assets/images/person_1.jpg" alt="Image placeholder" class="img-fluid mb-4">
